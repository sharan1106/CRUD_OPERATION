...
const Create = () => {
  ...
  return (
    <div>
    <h1 style={{textAlign :"center"}}>GAME DATA</h1>
    <form onSubmit={handleSubmit}>
        ...
        <div>
            ...
            <input type="text" name="Password" placeholder='Enter The password' onChange={handleChange}value={formData.password} />
        </div>
        <button type='submit' style={{marginLeft:"796px",marginTop:"15px"}}>Create</button>
